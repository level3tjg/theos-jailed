...
export OUTPUT_NAME ?= $(TWEAK_NAME)_$(_THEOS_INTERNAL_PACKAGE_VERSION).ipa
export EMBED_BUNDLES = $(strip $($(TWEAK_NAME)_EMBED_BUNDLES))
export EMBED_EXTENSIONS = $(strip $($(TWEAK_NAME)_EMBED_EXTENSIONS))
export EMBED_FRAMEWORKS = $(strip $($(TWEAK_NAME)_EMBED_FRAMEWORKS))
export EMBED_LIBRARIES = $(strip $($(TWEAK_NAME)_EMBED_LIBRARIES))
export _REMOVE_EXTENSIONS = $(call __theos_bool,$(or $(REMOVE_EXTENSIONS),$(_THEOS_FALSE)))
